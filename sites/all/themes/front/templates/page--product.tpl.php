...
if(!empty($product)){
    ...
    <div id="jssor_1" style="position:relative;margin:0px 8px 0px auto;top:0px;left:0px;width:1200px;height:380px;overflow:hidden;visibility:hidden; float:right;">
        ...
        <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1200px;height:380px;overflow:hidden;">
            <div data-b="0">
                <img data-u="image" src="<?php echo $base_url.'/'.path_to_theme();?>/img/banner.jpg" alt="<?php echo $product_title;?>" />
            </div>
            <div data-b="1" >
                <img data-u="image" src="<?php echo $image;?>" alt="<?php echo $product_title;?>" />
            </div>
        </div>
        <!-- Bullet Navigator -->
        <div data-u="navigator" class="jssorb05" style="bottom:16px;right:16px;width: 50%!important;" data-autocenter="1">
